...
SELECT 
    ...
    p.updated_on AS project_updated_on,
...
WHERE 
    p.owner_id = 123 OR pu.user_id = 123;
...
INSERT INTO APP_USER (USER_ID, NAME, EMAIL, PASSWORD) VALUES
(3, 'User Three', 'user3@example.com', 'password124'),
...
INSERT INTO PROJECT_USER (PROJECT_USER_ID, PROJECT_ID, USER_ID, ROLE, created_at, updated_at) VALUES
(5, 'proj_001', 3, 'Collaborator', 1622548800, 1622548800);
